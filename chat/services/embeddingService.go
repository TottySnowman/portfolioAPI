...
func (service *EmbeddingService) GetVectorByText(text string) (error, chatModel.FeatureExtractionResponse) {
	...
	if res.StatusCode != http.StatusOK {
		...
		return errors.New("Failed to get the thing"), nil
	}
	...
	return nil, featureExtractionResponse
}
